...
export default function BadgeComponent(props) {
    ...
    switch (props.type) {
        case "address": {
            ...
            const badgeElement = (_jsx("span", { className: `${styles.badge} ${styles.info} ${styles.monoFont} ${styles.addressBadge} ${className}`, ...rest, children: displayAddress }));
            ...
            if (link) {
                ...
                return (_jsx("a", { href: hrefValue, target: "_blank", rel: "noopener noreferrer", className: styles.badgeLink, children: wrappedElement }));
            }
        ...
        case "status": {
            ...
            const badgeElement = (_jsxs("span", { className: `${styles.badge} ${styles[variantValue]} ${styles.statusBadge} ${className}`, ...rest, children: [_jsx(StatusDotComponent, { variant: healthy ? "healthy" : "unhealthy", size: "sm", pulse: !!healthy }), _jsx("span", { className: styles.statusIcon, "aria-label": healthy ? "Healthy" : "Down", children: healthy ? "✓" : "✗" })] }));
        ...
        case "port": {
            ...
            if (!port)
                return null;
            const badgeElement = (_jsxs("span", { className: `${styles.badge} ${styles[variant] || ""} ${styles.monoFont} ${styles.portBadge} ${className}`, ...rest, children: [":", port] }));
        ...
        case "repository": {
            ...
            const badgeElement = (_jsxs("span", { className: `${styles.badge} ${styles.info} ${styles.monoFont} ${styles.repositoryBadge} ${className}`, ...rest, children: [Github && _jsx(Github, { size: 9, strokeWidth: 2.2 }), repositorySlug] }));
            const tooltipContent = tooltip || `GitHub: ${repositorySlug}`;
            const wrappedElement = (_jsx(TooltipComponent, { label: tooltipContent, position: "top", children: badgeElement }));
            return (_jsx("a", { href: targetHref, target: "_blank", rel: "noopener noreferrer", className: styles.badgeLink, children: wrappedElement }));
        }
        case "device": {
            ...
            if (!device)
                return null;
            const { Server } = icons || {};
            const badgeElement = (_jsxs("span", { className: `${styles.badge} ${styles.info} ${styles.deviceBadge} ${className}`, ...rest, children: [Server && _jsx(Server, { size: 9, strokeWidth: 2.2 }), device] }));
            ...
            const stateClassName = rainbow
                ...
                : isCountDisabled
                    ...
                    : state === "new"
                        ? styles.stateNew
                        : styles.stateDefault;
            const badgeElement = (_jsx("span", { className: `${styles.countBadge} ${stateClassName} ${className}`, children: count }));
            if (tooltip) {
                return (_jsx(TooltipComponent, { label: tooltip, position: "top", children: badgeElement }));
            }
            return badgeElement;
        ...
        case "responseTime": {
            ...
            const badgeElement = (_jsxs("span", { className: `${styles.badge} ${styles[responseTier.variant]} ${styles.monoFont} ${styles.responseTimeBadge} ${className}`, ...rest, children: [_jsx("span", { className: styles.responseTimeDot, "data-tier": responseTier.variant }), displayContent] }));
        ...
        case "domain": {
            ...
            if (!domain)
                return null;
            const { Globe } = icons || {};
            const badgeElement = (_jsxs("span", { className: `${styles.badge} ${styles.accent} ${styles.monoFont} ${styles.domainBadge} ${className}`, ...rest, children: [Globe && _jsx(Globe, { size: 9, strokeWidth: 2.2 }), domain] }));
            const tooltipContent = tooltip || `https://${domain}`;
            const wrappedElement = (_jsx(TooltipComponent, { label: tooltipContent, position: "top", children: badgeElement }));
            return (_jsx("a", { href: `https://${domain}`, target: "_blank", rel: "noopener noreferrer", className: styles.badgeLink, children: wrappedElement }));
        }
        case "visibility": {
