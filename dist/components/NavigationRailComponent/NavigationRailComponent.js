 ...
 */
export default function NavigationRailComponent({ items = [], activeItem, onNavigate, fab, menuIcon, alignment = "top", labelsHidden = false, bottomSlot, LinkComponent, className = "", ariaLabel = "Main navigation", }) {
