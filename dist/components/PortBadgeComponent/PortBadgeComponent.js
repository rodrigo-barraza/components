...
export default function PortBadgeComponent({ port, variant = "accent", className, ...rest }) {
    if (!port)
        return null;
    return (_jsxs(BadgeComponent, { variant: variant, className: `${styles.badge} ${className || ""}`, tooltip: `Listening on port ${port}`, ...rest, children: [":", port] }));
}
//# sourceMappingURL=PortBadgeComponent.js.map