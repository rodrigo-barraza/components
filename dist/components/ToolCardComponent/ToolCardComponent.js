...
export default function ToolCardComponent({ name, description, emoji, domain, onClick, children, className, }) {
    ...
    return (_jsxs("div", { className: classes, onClick: onClick, children: [_jsxs("div", { className: styles.header, children: [emoji && _jsx("span", { className: styles.emoji, children: emoji }), _jsxs("div", { className: styles.titleBlock, children: [_jsx("span", { className: styles.name, children: name }), domain && _jsx("span", { className: styles.domain, children: domain })] })] }), _jsx("div", { className: styles.description, children: description }), children && _jsx("div", { className: styles.footer, children: children })] }));
}
