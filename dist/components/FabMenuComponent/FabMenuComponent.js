...
const FabMenuComponent = forwardRef(function FabMenuComponent({ items = [], icon: TriggerIcon, closeIcon: CloseIcon, variant = "primary", fixed = false, showScrim = true, disabled = false, ariaLabel = "Actions menu", className = "", ...rest }, ref) {
    ...
    return (_jsxs(_Fragment, { children: [showScrim && (_jsx("div", { className: styles.scrim, "data-visible": isOpen, "aria-hidden": "true", onClick: close })), _jsxs("div", { ref: setContainerRef, className: containerClasses, onKeyDown: handleKeyDown, ...rest, children: [_jsx("div", { className: styles.itemsList, role: "menu", "aria-label": ariaLabel, "aria-hidden": !isOpen, children: items.map((item, index) => {
                            ...
                            _jsxs("svg", { width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", "aria-hidden": "true", children: [_jsx("line", { x1: "12", y1: "5", x2: "12", y2: "19" }), _jsx("line", { x1: "5", y1: "12", x2: "19", y2: "12" })] })) }) })] })] }));
});
