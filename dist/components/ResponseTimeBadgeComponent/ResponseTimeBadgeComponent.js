...
export default function ResponseTimeBadgeComponent({ ms, formatter, className, ...rest }) {
    ...
    return (_jsxs(BadgeComponent, { variant: tier.variant, tooltip: `${tier.label} — ${ms}ms`, className: `${styles.badge} ${className || ""}`, ...rest, children: [_jsx("span", { className: styles.dot, "data-tier": tier.variant }), display] }));
}
//# sourceMappingURL=ResponseTimeBadgeComponent.js.map